...
type Config struct {
	Compression    string `env:"D2_COMPRESSION" envDefault:"gzip" help:"Enable either gzip or br compression of HTTP/HTTPS responses; you may turn this off if you are using a reverse proxy"`
	LogDir         string `env:"D2_LOG_DIR" help:"The absolute directory path will store all logs generated by this application"`
