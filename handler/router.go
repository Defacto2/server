...
func (serv *Server) apiv1(sl *slog.Logger, e *echo.Echo, db *sql.DB, fsys fs.FS,
	...
	v1 := e.Group(api.APIBase)
	v1.Use(CacheMiddleware())
	v1.Use(APIMiddleware)
	v1.GET("/categories", func(c *echo.Context) error { return api.CategoriesAPI(c, db) })
	v1.GET("/category/:category", func(c *echo.Context) error { return api.CategoryAPI(sl, c, db) })
	v1.GET("/platforms", func(c *echo.Context) error { return api.PlatformsAPI(c, db) })
	v1.GET("/platform/:platform", func(c *echo.Context) error { return api.PlatformAPI(sl, c, db) })
	v1.GET("/milestones", api.MilestonesAPI)
	v1.GET("/milestones/highlights", api.MilestoneHighlightsAPI)
	v1.GET("/milestones/year/:year", api.MilestoneYearAPI)
	v1.GET("/milestones/years/:range", api.MilestoneYearsAPI)
	v1.GET("/milestones/decade/:decade", api.MilestoneDecadeAPI)
	v1.GET("/areacodes", api.AreacodesAPI)
	v1.GET("/areacode/:code", api.AreaCodeAPI)
	v1.GET("/areacodes/search/:query", api.AreacodeSearchAPI)
	v1.GET("/areacodes/regions", api.RegionsAPI)
	v1.GET("/areacodes/region/:abbr", api.RegionAPI)
	v1.GET("/websites", api.WebsitesAPI)
	v1.GET("/demozoo", api.DemozooAPI)
	v1.GET("/groups", func(c *echo.Context) error { return api.GroupsAPI(sl, c, db) })
	v1.GET("/sites", func(c *echo.Context) error { return api.SitesAPI(sl, c, db) })
	v1.GET("/boards", func(c *echo.Context) error { return api.BoardsAPI(sl, c, db) })
	v1.GET("/magazines", func(c *echo.Context) error { return api.MagazinesAPI(sl, c, db) })
	v1.GET("/releaser/:name", func(c *echo.Context) error { return api.ReleaserAPI(sl, c, db) })
	v1.GET("/artifacts", func(c *echo.Context) error { return api.ArtifactsAPI(sl, c, db) })
	v1.GET("/artifacts/new", func(c *echo.Context) error { return api.ArtifactsNewAPI(sl, c, db) })
	v1.GET("/artifact/:id", func(c *echo.Context) error { return api.FileAPI(sl, c, db) })
	v1.GET("/sceners", func(c *echo.Context) error { return api.ScenersAPI(sl, c, db) })
	v1.GET("/sceners/artist", func(c *echo.Context) error { return api.ArtistsAPI(sl, c, db) })
	v1.GET("/sceners/coder", func(c *echo.Context) error { return api.CodersAPI(sl, c, db) })
	v1.GET("/sceners/musician", func(c *echo.Context) error { return api.MusiciansAPI(sl, c, db) })
	v1.GET("/sceners/writer", func(c *echo.Context) error { return api.WritersAPI(sl, c, db) })
	v1.GET("/scener/:name", func(c *echo.Context) error { return api.ScenerAPI(sl, c, db) })
