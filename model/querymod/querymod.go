...
// AdvertExpr is a query mod expression for sale adverts.
...
// AnnouncementExpr is a query mod expression for announcement releases.
...
// AnsiExpr is a query mod expression for ANSI art releases.
...
// AnsiBBSExpr is a query mod expression for ANSI BBS art releases.
...
// AnsiFTPExpr is a query mod expression for ANSI FTP art releases.
...
// AnsiNfoExpr is a query mod expression for ANSI NFO releases.
...
// AnsiPackExpr is a query mod expression for ANSI art packs.
...
// AnsiBrandExpr is a query mod expression for ANSI brand art releases.
...
// AppleIIExpr is a query mod expression for Apple II text releases.
...
// AtariSTExpr is a query mod expression for Atari ST text releases.
...
// BBSExpr is a query mod expression for BBS releases.
...
// BBSImageExpr is a query mod expression for BBS image releases.
...
// BBStroExpr is a query mod expression for BBS releases on MS-DOS.
...
// BBSTextExpr is a query mod expression for BBS text releases.
...
// DemoExpr is a query mod expression for demo releases.
...
// DramaExpr is a query mod expression for community drama.
...
// FTPExpr is a query mod expression for FTP releases.
...
// HackExpr is a query mod expression for hack releases.
...
// InstallExpr is a query mod expression for install releases.
...
// IntroExpr is a query mod expression for intro releases.
...
// IntroDOSExpr is a query mod expression for intro releases on MS-DOS.
...
// IntroWindowsExpr is a query mod expression for Windows intro releases.
...
// JobAdvertExpr is a query mod expression for job advert releases.
...
// DOSExpr is a query mod expression for MS-DOS releases.
...
// DosPackExpr is a query mod expression for MS-DOS packs.
...
// HTMLExpr is a query mod expression for HTML releases.
...
// HowToExpr is a query mod expression for guides and how-tos.
...
// LinuxExpr is a query mod expression for Linux releases.
...
// JavaExpr is a query mod expression for Java releases.
...
// ImageExpr is a query mod expression for images.
...
// ImagePackExpr is a query mod expression for image file packs.
...
// MacExpr is a query mod expression for MacOS releases.
...
// MagExpr is a query mod expression for magazine releases.
...
// MusicExpr is a query mod expression for music releases.
...
// NewsArticleExpr is a query mod expression for news articles.
...
// NfoExpr is a query mod expression for NFO releases.
...
// NfoToolExpr is a query mod expression for NFO tool releases.
...
// ProofExpr is a query mod expression for proof releases.
...
// RestrictExpr is a query mod expression for restricted releases.
...
// ScriptExpr is a query mod expression for script and shell releases.
...
// StandardExpr is a query mod expression for release standards and rules.
...
// TakedownExpr is a query mod expression for bust and takedowns.
...
// TextExpr is a query mod expression for textfile releases.
...
// TextAmigaExpr is a query mod expression for Amiga text releases.
...
// TextPackExpr is a query mod expression for text releases.
...
// ToolExpr is a query mod expression for computer tool releases.
...
// TrialCrackmeExpr is a query mod expression for trial crackme releases.
...
// VideoExpr is a query mod expression for video releases.
...
// WindowsExpr is a query mod expression for Windows releases.
...
// WindowsPackExpr is a query mod expression for Windows file packs.
