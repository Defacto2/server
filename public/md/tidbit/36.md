...
<p class="h6 mt-3">Ten early intros</p>
<div style="font-size:22px;" class="font-dos reader reader-invert border border-black rounded-1 p-3 pb-4">
  <span class="text-bg-infox"> 3.5k 24 Jan 1990 KNIGHTS.EXE</span>
  <span class="text-bg-infox"> 3.5k 24 Jan 1990 STUNT.EXE</span>
  <span class="text-bg-infox"> 3.5k 24 Jan 1990 WHITE.EXE</span>
  <span class="text-bg-infox"> 3.5k 29 Jan 1990 CASTLE.EXE</span>
  <span class="text-bg-infox"> 3.5k 29 Jan 1990 LOADER.EXE</span>
  <span class="text-bg-infox"> 3.5k  1 Feb 1990 AJAX.EXE</span>
  <span class="text-info bg-dark"> 3.5k  2 Feb 1990 EDITOR.EXE </span>
  <span class="text-warning bg-dark"> 3.1k  7 Feb 1990 BUBBLE.COM </span>
  <span class="text-bg-warningx"> 3.1k  8 Feb 1990 STARTREK.COM</span>
  <span class="text-bg-warningx"> 3.1k 20 Feb 1990 CRIME.COM</span>
</div>
<p class="mt-3">
  Another oddity, the first seven included intros were released as uncompressed MS-DOS "MZ" executables, 
  that can be viewed and edited using a hex editor. But the Bubble Bobble's intro, 
  the other later intros are compressed COM executables that reduce the size and protect the content.
</p>
