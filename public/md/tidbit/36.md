...
<p class="my-3">
  Another oddity, the first seven intros were released as uncompressed MS-DOS "MZ" executables, 
  that can be hacked using a hex editor. But Bubble Bobble and the later intros are 
  compressed COM executables that reduce the binary size and obfuscates the content.
</p>
